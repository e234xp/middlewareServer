...
module.exports = async (data) => {
  global.spiderman.systemlog.generateLog(4, `wiegandconverter find ${JSON.stringify(data)}`);
  ...
  global.spiderman.systemlog.generateLog(4, `wiegandconverter find ${JSON.stringify(ret)}`);
