...
module.exports = async (data) => {
  global.spiderman.systemlog.generateLog(4, `manualclockinresult query ${JSON.stringify(data)}`);
  ...
  global.spiderman.systemlog.generateLog(4, `manualclockinresult query ${JSON.stringify(ret)}`);
