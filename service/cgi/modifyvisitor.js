...
function modifyData( res, uuid, data, faceImage = "", faceFeature = "", upperFaceFeature = "" ) {
    ...
    if( data.display_image != null ) dataToWrite["base64_display_photo_image"] = data.base64_display_photo_image ;
    ...
    try {
        global.airaFaceLiteVisitorDb.update( uuid, dataToWrite, true, function( ok ) {
