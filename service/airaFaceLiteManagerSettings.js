...
class airaFaceLiteManagerSettings {
    constructor( workingFolder, filename ) {
        ...
        self.defaultSettings = function() {
            return {
                ...
                manager_host : "",
                manager_port : 8443,
                manager_token_key : "aira83522758"
            }
        };
        ...
        self.readFromFile = async function( cb ) {
            ...
            try {
                ...
                //console.log("readFromFile dbStr", dbStr, self.dbfileName)
                data = JSON.parse( dbStr );

                //console.log("readFromFile a", data)
            }
            catch(e) {
...
module.exports = airaFaceLiteManagerSettings;
